...
(assert (forall ((|$knormal:5| Int)
         ...
         (|$V-reftype:17| Int)
         (|$knormal:7| Int))
    (=> (and (|zip$unknown:3| |$knormal:7|
                                   |$knormal:5|
                                   |$knormal:3|)
             (|zip$unknown:2| |$alpha-2:y| |$alpha-1:x|)
	     (f |$V-reftype:17| |$alpha-2:y| |$alpha-1:x|))
        (|zip$unknown:3| |$V-reftype:17| |$alpha-2:y| |$alpha-1:x|))))
...
(assert (forall ((|$knormal:12| Int)
         (|$knormal:10| Int)
         (|$knormal:11| Int)
         (|$knormal:15| Int)
         (|$alpha-3:n| Int))
  (let ((a!1 (= (not (= 0 |$knormal:12|))
                (and (not (= 0 |$knormal:10|))
                     (not (= 0 |$knormal:11|))))))
  (let ((a!2 (and a!1
                  (= (not (= 0 |$knormal:11|))
                     (<= |$knormal:15| |$alpha-3:n|))
                  (= (not (= 0 |$knormal:10|))
                     (>= |$knormal:15| |$alpha-3:n|))
                  (not (not (= 0 |$knormal:12|)))
                  (|zip$unknown:3| |$knormal:15|
                                   |$alpha-3:n|
                                   |$alpha-3:n|))))
    (=> a!2 false)))))
(check-sat)
