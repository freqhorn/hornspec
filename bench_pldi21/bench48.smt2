...
(assert (forall ((x0 Int) (x1 Int) (x2 Int) (x3 Int)) (=> (and (P0 x0) (P1 x0 x1) (P2 x0 x1 x2) (P0 x3) (f x2 x3 x0)) (P3 x0 x1 x2 x3))))
...
;(assert (forall ((x2 Int) (x0 Int) (x1 Int)) (=> (and (>= x0 0) (>= x1 0) (= x2 0)) (P0 x2))))
(assert (forall ((x2 Int) (x3 Int) (x0 Int) (x1 Int)) (=> (and (>= x0 0) (>= x1 0) (= x2 0) (= x3 1)) (P1 x2 x3))))
(assert (forall ((x3 Int) (x4 Int) (x0 Int) (x1 Int) (x2 Int)) (=> (and (>= x1 0) (>= x2 0) (= x3 0) (= x4 1)) (P2 x3 x4 x0))))
(assert (forall ((x0 Int) (x1 Int) (x3 Int) (x2 Int)) (=> (and (P3 0 1 x2 x3) (>= x0 0) (>= x1 0) (<= (+ 1 x3) 0)) false)))
(check-sat)
