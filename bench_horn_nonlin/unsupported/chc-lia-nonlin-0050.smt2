;; Original file: enc-zip_map2.smt2
(set-logic HORN)
...
(assert (forall ((x1 Int) (x0 Int) (x2 Int) (x3 Int)) (=> (and (P4 x1) (P6 x2 x3) (f x1 x2 x0 x3)) (P6 x1 x0))))
(assert (forall ((x0 Int)) (=> true (P2 x0))))
(assert (forall ((x1 Int) (x0 Int)) (=> (= x0 x1) (P3 x1 x0))))
(assert (forall ((x1 Int) (x0 Int)) (=> (P5 x0 x0 x1) (P4 x1))))
(assert (forall ((x0 Int)) (=> (and (P2 0) (P3 0 x0) (or (< x0 0) (> x0 0))) false)))
(assert (forall ((x0 Int)) (=> (and (P2 x0) (P3 x0 0) (or (< x0 0) (> x0 0))) false)))
