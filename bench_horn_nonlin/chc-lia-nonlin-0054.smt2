...
(assert (forall ((x0 Int) (x4 Int) (x1 Int) (x2 Int) (x3 Int)) (=> (and (P3 x1 x2) (P4 x1 x2 x3) (P2 x2 x3 x0) (P5 x1 x2 x3 x4)) (P1 x0 x4))))
(assert (forall ((x0 Int) (x1 Int) (x2 Int) (x4 Int) (x5 Int) (x3 Int)) (=> (and (P3 x0 x1) (P4 x0 x1 x2) (P2 x1 x2 x3) (P5 x0 x1 x2 x4) (P2 x3 x4 x5)) (P8 x0 x1 x2 x4 x5))))
...
(assert (forall ((x5 Int) (x4 Int) (x0 Int) (x3 Int) (x1 Int) (x2 Int)) (=> (and (P8 x0 x3 x1 x2 x4) (P9 x3 x4 x5) (or (< x5 x4) (> x5 x4))) false)))
(check-sat)
