...
(assert (forall ((intloopcounter.__intloopcounter_3 Bool)
  ...
  (let ((a!1 (and (or (not (= intloopcounter.__intloopcounter_3 true))
                      (= intloopcounter.time 0))
                  (or (not (= intloopcounter.__intloopcounter_3 false))
                      (= intloopcounter.time
                         (+ intloopcounter.__intloopcounter_2_c 1))))))
  (let ((a!2 (and (= intloopcounter.__intloopcounter_3
                  ...
                  (or (not (= intloopcounter.__intloopcounter_1 true))
                      (= intloopcounter.time 0))
                  (or (not (= intloopcounter.__intloopcounter_1 false)) a!1)
