...
(assert (forall ((x1 Int) (x0 Int)) (=> (and (P6 x0) (P7 x0 x1) (>= x0 0)) (P2 x1))))
(assert (forall ((x0 Int) (x1 Int) (x2 Int)) (=> (and (P6 x0) (P7 x0 x1) (P3 x1 x2) (>= x0 0)) (P9 x0 x1 x2))))
(assert (forall ((x1 Int) (x0 Int) (x2 Int)) (=> (and (P6 x1) (P7 x1 x0) (P7 x1 x2) (<= (+ 1 x1) 0) (= x2 x0)) (P9 x1 x0 x2))))
