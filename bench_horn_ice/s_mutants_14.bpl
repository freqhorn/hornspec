...
function {:existential true} b0(x:int, i:int, j:int, k:int, l:int, m:int): bool;
...
$bb0:
  ...
  goto $bb1;
$bb1:
  assert b0($x, $i, $j, $k, $l, $m);
  //$b := $sge($p, $p1);
  goto $bb2, $bb3;
$bb2:
  $x1 := $add($add($add($add($add($x, $i), $j), $k), $l), $m);
  $i1 := $add($add($add($add($add($x, $i), $j), $k), $l), $m);
  $j1 := $add($add($add($add($add($x, $i), $j), $k), $l), $m);
  $k1 := $add($add($add($add($add($x, $i), $j), $k), $l), $m);
  $l1 := $add($add($add($add($add($x, $i), $j), $k), $l), $m);
  $m1 := $add($add($add($add($add($x, $i), $j), $k), $l), $m);
  $x := $x1;
  $i := $i1;
  $j := $j1;
  $k := $k1;
  ...
  goto $bb1;
$bb3:
  $b2 := ($add($add($add($add($x, $i), $j), $k), $l) == $mul($m, 5));
  assert $b2;
  return;
}
